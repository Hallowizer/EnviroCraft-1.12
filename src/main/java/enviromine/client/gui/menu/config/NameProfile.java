...
public class NameProfile extends GuiScreen
{
	...
	public void initGui()
	{
        ...
        this.textFieldList = new GuiTextField(this.fontRenderer, this.width / 2 - 100, 60, 200, 20);
	...
	public void drawScreen(int par1, int par2, float par3)
	{
		...
		this.drawCenteredString(this.fontRenderer, I18n.format("editor.enviromine.nameProfile"), this.width / 2, 15, 16777215);
